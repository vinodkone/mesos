...
case $OS in
  ...
  *ubuntu*)
    ...
    append_dockerfile "RUN apt-get -y install openjdk-8-jdk python-dev python-six libcurl4-nss-dev libsasl2-dev libapr1-dev libsvn-dev libevent-dev libev-dev"
